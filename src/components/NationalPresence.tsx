...
const NationalPresence = () => (
  <SectionContainer
    ...
    style={{
      backgroundImage:
        "linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url('/lovable-uploads/597d1cf2-94e0-4cff-8e85-a903c1a11fe4.png')",
  ...
  >
    <div className="absolute top-6 md:top-8 left-1/2 transform -translate-x-1/2 z-10 text-center">
      ...
      <div className="w-20 md:w-24 h-px bg-gold-accent mx-auto mb-4 md:mb-6" />
    </div>
    ...
    <div className="w-full h-full flex flex-col lg:flex-row lg:justify-between items-center px-4 md:px-8 pt-20 md:pt-0 gap-6 lg:gap-0">
      <div className="flex flex-col lg:hidden space-y-4 w-full max-w-md">
        <div className="text-cream-editorial text-center">
          <p className="text-sm md:text-base font-editorial leading-relaxed mb-3">
            Planejar é mais do que escolher espaços, é entender as ruas
          </p>
          <p className="text-sm md:text-base font-editorial leading-relaxed">
            Essas são as praças em que eu já estive em visita técnica
          </p>
        </div>
        {cityGroups.map((group) => (
          <div
            key={group.region}
            className="bg-gold-accent/95 rounded-lg p-3 shadow-lg"
          >
        ...
        <div className="flex flex-col space-y-12 w-1/3">
          <div className="text-cream-editorial">
            <p className="text-lg font-editorial leading-relaxed mb-3">
              Planejar é mais do que escolher espaços, é entender as ruas Essas
              são as praças em que eu já estive em visita técnica
            </p>
