...
export const ExperienceCard = ({ experience }: ExperienceCardProps) => (
  <div className="min-w-[420px] w-[420px] h-[400px] bg-white-pure text-ink-black border border-grey-sophisticated/20 flex flex-col justify-between p-8 transition-all duration-500 hover:shadow-gold hover:border-gold-accent group hover-lift">
    {/* Tag Section */}
    ...
    <div className="flex-1 flex items-center justify-center mb-8">
      <div className="w-40 h-20 flex items-center justify-center p-4 bg-cream-editorial/50 group-hover:bg-gold-accent/10 transition-colors duration-300">
        <img
    ...
    <div className="text-center">
      ...
      <p className="text-sm text-slate-elegant font-editorial leading-relaxed">
