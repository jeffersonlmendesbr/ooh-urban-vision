...
export const ExperienceCard = ({ experience }: ExperienceCardProps) => (
  <div className="min-w-[420px] w-[420px] h-[680px] bg-white-pure text-ink-black border border-grey-sophisticated/20 flex flex-col justify-between p-8 transition-all duration-500 hover:shadow-gold hover:border-gold-accent group hover-lift">
    {/* Tag Section */}
