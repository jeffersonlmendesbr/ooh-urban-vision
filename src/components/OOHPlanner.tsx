...
const OOHPlanner = () => {
  return (
    <section id="oohplanner" className="min-h-screen flex items-center py-24 bg-gradient-to-br from-[#4B82F8] via-[#FFFFFF] via-[#F0F0F0] to-[#D0B0DF] text-[#080808] relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 text-center relative z-10">
        ...
        <h2 className="font-display text-5xl md:text-6xl lg:text-7xl text-[#FFFFFF] mb-12 leading-none drop-shadow-lg">
          OOHPlanner
        </h2>
        ...
        <div className="bg-gradient-to-r from-[#660099] via-[#CB2166] to-[#D0B0DF] p-12 md:p-16 shadow-lg hover-lift backdrop-blur-sm mb-8">
