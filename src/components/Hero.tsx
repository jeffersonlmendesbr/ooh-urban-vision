...
const Hero = () => {
  return <section id="hero" className="h-screen w-full flex items-center justify-end relative overflow-hidden bg-ink-black pr-20">
      ...
      <div className="relative z-10 text-center text-white-pure max-w-3xl">
        {/* Editorial Quote */}
        <div className="mb-8">
